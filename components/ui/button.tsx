...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-none border bg-clip-padding text-xs font-semibold tracking-widest whitespace-nowrap uppercase transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground shadow-[0_4px_24px_-4px_color-mix(in_oklch,var(--glow),transparent_55%)] hover:bg-primary/90 hover:shadow-[0_6px_32px_-4px_color-mix(in_oklch,var(--glow),transparent_45%)]",
        outline:
          "border-primary/60 bg-transparent text-foreground hover:border-primary hover:bg-primary/8 hover:text-primary aria-expanded:border-primary aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary:
